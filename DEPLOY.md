...
3. Open **SQL Editor** and run `SUPABASE_SETUP.sql`
   - If you already ran an older version, run the latest file again to add avatars storage, notifications, direct messages, and moderation/reporting tables/policies.
